...
void Widget::initCharts()
{
    ...
    qDebug()<<"init charts successfully！"<<'\n';
}
...
void Widget::displayButtonClick()
{
    ...
    qDebug()<<"start drawSplineWave 3"<<'\n';

    drawTimer = new QTimer(this);                       //定时任务
    //定时器每计时到1ms，将引起超时事件，从而绘制曲线和点
    connect(drawTimer, SIGNAL(timeout()), this, SLOT(drawSplineWave()));
    drawTimer->start(1);                                //10ms执行一次

    qDebug()<<"start drawSplineWave "<<'\n';
}
//暂停按钮，停止定时器
...
//    for(int i=0;i<27;i++){
//        qDebug()<<"enter drawSplineWave for loop"<<'\n';
//        while (readData->pointBuffer[i].size() != 0){
//            qDebug()<<"before readData->pointBuffer[i].dequeue();"<<'\n';
//            drawPoint = readData->pointBuffer[i].dequeue();
//            splineSeries[i].replace(axis_x_counts,QPointF(axis_x_counts,readData->pointBuffer[i].dequeue()));
//            axis_x_counts ++;
//            if(axis_x_counts>readData->count)
//                axis_x_counts = 0;
//        }
...
//    for(int i=0;i<27;i++){
//        splineSeries2[i].replace(axis_x_counts,QPointF(axis_x_counts,readData->pointBuffer[i].dequeue()));
//    }
...
//                lineSeries[T1X].replace(readData->pointBuffer_P[j].dequeue(),QPointF(readData->pointBuffer_P[j].dequeue(),0));
//                lineSeries[T1Y].replace(readData->pointBuffer_P[j].dequeue(),QPointF(readData->pointBuffer_P[j].dequeue(),0));
//                lineSeries[T1Z].replace(readData->pointBuffer_P[j].dequeue(),QPointF(readData->pointBuffer_P[j].dequeue(),0));

//                lineSeries2[T1X].replace(readData->pointBuffer_P[j].dequeue(),QPointF(readData->pointBuffer_P[j].dequeue(),0));
//                lineSeries2[T1Y].replace(readData->pointBuffer_P[j].dequeue(),QPointF(readData->pointBuffer_P[j].dequeue(),0));
//                lineSeries2[T1Z].replace(readData->pointBuffer_P[j].dequeue(),QPointF(readData->pointBuffer_P[j].dequeue(),0));
//            }
//            if(2==j){
//                lineSeries[T2X].replace(readData->pointBuffer_P[j].dequeue(),QPointF(readData->pointBuffer_P[j].dequeue(),0));
//                lineSeries[T2Y].replace(readData->pointBuffer_P[j].dequeue(),QPointF(readData->pointBuffer_P[j].dequeue(),0));
//                lineSeries[T2Z].replace(readData->pointBuffer_P[j].dequeue(),QPointF(readData->pointBuffer_P[j].dequeue(),0));

//                lineSeries2[T2X].replace(readData->pointBuffer_P[j].dequeue(),QPointF(readData->pointBuffer_P[j].dequeue(),0));
//                lineSeries2[T2Y].replace(readData->pointBuffer_P[j].dequeue(),QPointF(readData->pointBuffer_P[j].dequeue(),0));
//                lineSeries2[T2Z].replace(readData->pointBuffer_P[j].dequeue(),QPointF(readData->pointBuffer_P[j].dequeue(),0));
//            }
//            if(3==j){
//                lineSeries[T3X].replace(readData->pointBuffer_P[j].dequeue(),QPointF(readData->pointBuffer_P[j].dequeue(),0));
//                lineSeries[T3Y].replace(readData->pointBuffer_P[j].dequeue(),QPointF(readData->pointBuffer_P[j].dequeue(),0));
//                lineSeries[T3Z].replace(readData->pointBuffer_P[j].dequeue(),QPointF(readData->pointBuffer_P[j].dequeue(),0));

//                lineSeries2[T3X].replace(readData->pointBuffer_P[j].dequeue(),QPointF(readData->pointBuffer_P[j].dequeue(),0));
//                lineSeries2[T3Y].replace(readData->pointBuffer_P[j].dequeue(),QPointF(readData->pointBuffer_P[j].dequeue(),0));
//                lineSeries2[T3Z].replace(readData->pointBuffer_P[j].dequeue(),QPointF(readData->pointBuffer_P[j].dequeue(),0));
//            }
//            if(4==j){
//                lineSeries[T4X].replace(readData->pointBuffer_P[j].dequeue(),QPointF(readData->pointBuffer_P[j].dequeue(),0));
//                lineSeries[T4Y].replace(readData->pointBuffer_P[j].dequeue(),QPointF(readData->pointBuffer_P[j].dequeue(),0));
//                lineSeries[T4Z].replace(readData->pointBuffer_P[j].dequeue(),QPointF(readData->pointBuffer_P[j].dequeue(),0));

//                lineSeries2[T4X].replace(readData->pointBuffer_P[j].dequeue(),QPointF(readData->pointBuffer_P[j].dequeue(),0));
//                lineSeries2[T4Y].replace(readData->pointBuffer_P[j].dequeue(),QPointF(readData->pointBuffer_P[j].dequeue(),0));
//                lineSeries2[T4Z].replace(readData->pointBuffer_P[j].dequeue(),QPointF(readData->pointBuffer_P[j].dequeue(),0));
//            }
//            if(5==j){
//                lineSeries[T5X].replace(readData->pointBuffer_P[j].dequeue(),QPointF(readData->pointBuffer_P[j].dequeue(),0));
//                lineSeries[T5Y].replace(readData->pointBuffer_P[j].dequeue(),QPointF(readData->pointBuffer_P[j].dequeue(),0));
//                lineSeries[T5Z].replace(readData->pointBuffer_P[j].dequeue(),QPointF(readData->pointBuffer_P[j].dequeue(),0));

//                lineSeries2[T5X].replace(readData->pointBuffer_P[j].dequeue(),QPointF(readData->pointBuffer_P[j].dequeue(),0));
//                lineSeries2[T5Y].replace(readData->pointBuffer_P[j].dequeue(),QPointF(readData->pointBuffer_P[j].dequeue(),0));
//                lineSeries2[T5Z].replace(readData->pointBuffer_P[j].dequeue(),QPointF(readData->pointBuffer_P[j].dequeue(),0));
//            }
//            if(6==j){
//                lineSeries[T6X].replace(readData->pointBuffer_P[j].dequeue(),QPointF(readData->pointBuffer_P[j].dequeue(),0));
//                lineSeries[T6Y].replace(readData->pointBuffer_P[j].dequeue(),QPointF(readData->pointBuffer_P[j].dequeue(),0));
//                lineSeries[T6Z].replace(readData->pointBuffer_P[j].dequeue(),QPointF(readData->pointBuffer_P[j].dequeue(),0));

//                lineSeries2[T6X].replace(readData->pointBuffer_P[j].dequeue(),QPointF(readData->pointBuffer_P[j].dequeue(),0));
//                lineSeries2[T6Y].replace(readData->pointBuffer_P[j].dequeue(),QPointF(readData->pointBuffer_P[j].dequeue(),0));
//                lineSeries2[T6Z].replace(readData->pointBuffer_P[j].dequeue(),QPointF(readData->pointBuffer_P[j].dequeue(),0));
//            }
//            if(7==j){
//                lineSeries[T7X].replace(readData->pointBuffer_P[j].dequeue(),QPointF(readData->pointBuffer_P[j].dequeue(),0));
//                lineSeries[T7Y].replace(readData->pointBuffer_P[j].dequeue(),QPointF(readData->pointBuffer_P[j].dequeue(),0));
//                lineSeries[T7Z].replace(readData->pointBuffer_P[j].dequeue(),QPointF(readData->pointBuffer_P[j].dequeue(),0));

//                lineSeries2[T7X].replace(readData->pointBuffer_P[j].dequeue(),QPointF(readData->pointBuffer_P[j].dequeue(),0));
//                lineSeries2[T7Y].replace(readData->pointBuffer_P[j].dequeue(),QPointF(readData->pointBuffer_P[j].dequeue(),0));
//                lineSeries2[T7Z].replace(readData->pointBuffer_P[j].dequeue(),QPointF(readData->pointBuffer_P[j].dequeue(),0));
//            }
//            if(8==j){
//                lineSeries[T8X].replace(readData->pointBuffer_P[j].dequeue(),QPointF(readData->pointBuffer_P[j].dequeue(),0));
//                lineSeries[T8Y].replace(readData->pointBuffer_P[j].dequeue(),QPointF(readData->pointBuffer_P[j].dequeue(),0));
//                lineSeries[T8Z].replace(readData->pointBuffer_P[j].dequeue(),QPointF(readData->pointBuffer_P[j].dequeue(),0));

//                lineSeries2[T8X].replace(readData->pointBuffer_P[j].dequeue(),QPointF(readData->pointBuffer_P[j].dequeue(),0));
//                lineSeries2[T8Y].replace(readData->pointBuffer_P[j].dequeue(),QPointF(readData->pointBuffer_P[j].dequeue(),0));
//                lineSeries2[T8Z].replace(readData->pointBuffer_P[j].dequeue(),QPointF(readData->pointBuffer_P[j].dequeue(),0));
//            }
//            if(9==j){
//                lineSeries[T9X].replace(readData->pointBuffer_P[j].dequeue(),QPointF(readData->pointBuffer_P[j].dequeue(),0));
//                lineSeries[T9Y].replace(readData->pointBuffer_P[j].dequeue(),QPointF(readData->pointBuffer_P[j].dequeue(),0));
//                lineSeries[T9Z].replace(readData->pointBuffer_P[j].dequeue(),QPointF(readData->pointBuffer_P[j].dequeue(),0));

//                lineSeries2[T9X].replace(readData->pointBuffer_P[j].dequeue(),QPointF(readData->pointBuffer_P[j].dequeue(),0));
//                lineSeries2[T9Y].replace(readData->pointBuffer_P[j].dequeue(),QPointF(readData->pointBuffer_P[j].dequeue(),0));
//                lineSeries2[T9Z].replace(readData->pointBuffer_P[j].dequeue(),QPointF(readData->pointBuffer_P[j].dequeue(),0));
//            }
//        }
//    }
}
